...
hparams = tf.contrib.training.HParams(
    ...
    max_iters=10000,  # 1000 changed # Max decoder steps during inference (Just for safety from infinite loop cases)
    ...
    max_time_steps=11000,#11000 changed, also in terminal_train_log
